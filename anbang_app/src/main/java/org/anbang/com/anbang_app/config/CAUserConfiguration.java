...
public class CAUserConfiguration implements User {
    ...
    public CAUserConfiguration(String userId, String orgMSP, String affiliation,
    ...
    public static class CAUserBuilder {
        ...
        public CAUserConfiguration build() {
            return new CAUserConfiguration(userId, orgMSP, affiliation, identity, roles, account);
        }
